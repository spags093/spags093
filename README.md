...
### ⚡ Skills:
Python Development, Machine Learning, Deep Learning Data Analysis, AWS, Data Visualization, Computer Vision, Natural Language Processing (NLP), SQL queries, Tabeleau Dashboards, Team Building, Overcoming Adversity, Working in "Crisis Mode"

### ✨ Technologies: 
<b><u>Languages:</u></b> Python, SQL, Microsoft SQL Server, PostgresSQL, and Flask<br>
<b><u>Analysis & Visualization:</u></b> Pandas, Numpy, Matplotlib, Seaborn, Plotly, SHAP, Lime, Google Colab, Tableau, and Dash<br>
<b><u>Modeling:</u></b> Statsmodels, Scikit-learn, Tensorflow/Keras, Pyspark, NLTK, TFLearn, and Pycaret
